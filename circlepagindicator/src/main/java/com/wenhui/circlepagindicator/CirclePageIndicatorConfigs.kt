...
class CirclePageIndicatorConfigs(
  ...
  class Builder(private val context: Context) {
    ...
    @ColorInt
    var activeColor: Int = ACTIVE_COLOR
    @ColorInt
    var inactiveColor: Int = INACTIVE_COLOR
    ...
    @Px
    var indicatorBackgroundHeight: Int = INDICATOR_BACKGROUND_HEIGHT_IN_DP.toDp(context)
    @Px
    var indicatorBottomMargin: Int = INDICATOR_BOTTOM_MARGIN_IN_DP.toDp(context)
    ...
    @Px
    var indicatorSpacing: Int = INDICATOR_SPACE_IN_DP.toDp(context)
