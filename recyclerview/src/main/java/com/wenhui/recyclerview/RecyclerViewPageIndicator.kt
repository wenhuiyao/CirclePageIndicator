 ...
 * indicators
 */
class RecyclerViewPageIndicator(private val configs: CirclePageIndicatorConfigs) {
    ...
    private fun tryRegisterAdapter(recyclerView: RecyclerView, pageIndicator: CirclePageIndicator<RecyclerView>): Boolean {
